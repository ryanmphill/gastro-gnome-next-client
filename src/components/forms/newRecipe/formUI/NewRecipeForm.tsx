...
export const NewRecipeForm = ({ genres, allIngredients, allCategories }: RecipeFormProps) => {
    ...
    // but the formData does not contain the data for ingredients or categories since the values aren't
    ...
    // If we wanted to store these in the formData object, an alternative would be to store
